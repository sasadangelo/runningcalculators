...
* **Race Predictor**, this calculator predicts your estimated time and pace for any popular running race distance from 5K to the Marathon starting from the result of a previous race. 
